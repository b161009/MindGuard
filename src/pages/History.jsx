  ...
  return (
    <main className="page">
      <div className="container history-container">
        <div className="page-intro"><span className="eyebrow">LỊCH SỬ CÁ NHÂN</span><h1>Nhìn vào xu hướng, không chỉ một ngày.</h1><p>Mind Guard ưu tiên các thay đổi kéo dài trong 7 và 30 ngày hơn là kết luận từ một câu trả lời riêng lẻ.</p></div>
        ...
        <div className="history-charts"><MoodChart entries={entries} /><StressChart entries={entries} /><RiskChart entries={entries} /></div>
